...
const LabelInput = ({ id, type, labelText, autoComplete, required, placeHolder }:
    ...
    return <div>
        ...
        <Input name={id} id={id} placeholder={placeHolder ? placeHolder : labelText} required={required} type={type} autoComplete={autoComplete} />
    </div>
}
...
export { TimePickerInput , LabelInput};